---
title: "My Free Software Activities in Jan 2026"
emoji: "🪔"
type: "tech"
topics: ["Debian"]
published: false
...
1月は、既存パッケージのスポンサーをしたりした。
印象に残っているのが、gr-frameworkで利用できるフォントに関して、
fonts-stixが1.xから2.xに刷新されるにあたって、現在のgr-frameworkでは
扱えないことがわかったのが印象的だった。
