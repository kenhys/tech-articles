...
Today, hal-flash package was removed from Debian testing/unstable, and it means that it will not shipped for bullseye.
...
hal-flash package was already orphaned years ago, but it was very useful.
