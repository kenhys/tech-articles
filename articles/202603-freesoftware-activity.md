...
3月はmozcのFTBFS関係にフィードバックしたり、morisawaフォントのFTBFSにフィードバックしたりした。

mozcがGTK2に依存している問題については、forkyまでに修正できればよいと考えていたが、
Ubuntu 26.04ではアウトということで除外される危機があったのが騒ぎになっていたのが印象に残っている。

誰かがメンテナンスしているのが当たり前ではないというのは普遍的な価値観ではないのかもしれない。
